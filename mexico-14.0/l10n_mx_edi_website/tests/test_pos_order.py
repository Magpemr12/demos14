...
class TestTicketInvoicing(TestPointOfSaleCommon):
    ...
    def create_orders(self):
        ...
        self.ticket_no_partner = self.order_obj.browse(
            [pos['id'] for pos in without_ids])
        ...
        self.not_invoiced_valid_partner = self.order_obj.browse(
            [pos['id'] for pos in with_ids])
        ...
        self.invoiced_ticket = self.order_obj.browse(
            [pos['id'] for pos in invoiced_ids])
    ...
    def test_004_invoice_by_vat(self):
        ...
        self.assertEqual(res.get('invoice'),
                         self.ticket_no_partner.account_move)
    ...
    def _test_009_invoice_session_closed(self):
