...
class AccountMove(models.Model):
    ...
    def _compute_payments_widget_to_reconcile_info(self):
        ...
        for move in self.filtered(lambda inv: inv.state == 'draft' and
            ...
            domain.extend([('move_id.invoice_payment_state', '=', 'paid')])
    ...
    def post(self):
        ...
        """
        with_advance = self.filtered(lambda r: r.move_type == 'out_invoice' and
                                     r.company_id.l10n_mx_edi_advance == 'A' and
                                     r._l10n_mx_edi_get_advance_uuid_related())
        advance_b = self.filtered(lambda r: r.move_type == 'out_invoice' and
        ...
        for inv in with_advance:
            ...
            moves = inv.reversed_entry_id.line_ids.filtered(lambda line: line.account_id == account)
